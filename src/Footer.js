...
const Footer = () => {
  return (
    <footer class="site-footer">
      <img class="site-footer-logo" src="logoa.jpg" alt="Little Lemon" />
      ...
      <div class="site-footer-social">
        ...
        <a href="https://www.facebook.com" target="_blank" rel="noreferrer">
          <svg
            ...
            data-prefix="fab"
            data-icon="facebook"
            className="svg-inline--fa fa-facebook fa-lg "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            style={{ width: '24px', height: '24px', color: 'white' }}>
        ...
        <a href="https://www.instagram.com" target="_blank" rel="noreferrer">
          <svg
            ...
            data-prefix="fab"
            data-icon="instagram"
            className="svg-inline--fa fa-instagram fa-lg "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
            style={{ width: '24px', height: '24px', color: 'white' }}>
        ...
        <a href="https://www.twitter.com" target="_blank" rel="noreferrer">
          <svg
            ...
            data-prefix="fab"
            data-icon="twitter"
            className="svg-inline--fa fa-twitter fa-lg "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            style={{ width: '24px', height: '24px', color: 'white' }}>
        ...
        <a href="https://www.youtube.com" target="_blank" rel="noreferrer">
          <svg
            ...
            data-prefix="fab"
            data-icon="youtube"
            className="svg-inline--fa fa-youtube fa-lg "
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 576 512"
            style={{ width: '24px', height: '24px', color: 'white' }}>
