...
const Specials = () => {
  return (
    <section class="container grid week-specials" id="menu">
      <div class="week-specials-header">
        <h2>This week specials!</h2>
        <a class="button-primary" href="/#menu">
          Online Menu
        </a>
      </div>
        ...
        <div class="meal-card-body-footer">
          ...
          <a href="/orderOnline">
            ...
            <svg
              ...
              class="svg-inline--fa fa-motorcycle responsive-icon"
              role="img"
